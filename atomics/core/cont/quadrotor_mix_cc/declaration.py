...
Function(
    name='core.cont.quadrotor_mix_cc',
    title=LocalizedString(
        en='Mixer for the classic X quad-rotor control signal with clamped collective '
           'control for avoiding roll and pitch control saturation.'
    ),
    parameters=[
        Parameter(
            name='Kt_m1',
